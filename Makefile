# This Makefile is for the Tapper::Test extension to perl.
#
...
#     ABSTRACT => q[Tapper - Utilities for Perl based Tapper testing]
#     AUTHOR => q[AMD OSRC Tapper Team, C<< <tapper at amd64.org> >>, AMD OSRC Tapper Team <tapper@amd64.org>]
#     BUILD_REQUIRES => { Test::Perl::Critic=>q[0], ExtUtils::MakeMaker=>q[6.42] }
#     DISTNAME => q[Tapper-Test]
#     LICENSE => q[freebsd]
...
PARENT_NAME = Tapper
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Tapper/Test.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
TO_INST_PM = lib/Tapper/Test.pm

PM_TO_BLIB = lib/Tapper/Test.pm \
	blib/lib/Tapper/Test.pm
...
DISTVNAME = Tapper-Test-3.000012
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Tapper/Test.pm $(INST_MAN3DIR)/Tapper::Test.$(MAN3EXT) 
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="3.000012">' > $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Tapper/Test.pm blib/lib/Tapper/Test.pm 
